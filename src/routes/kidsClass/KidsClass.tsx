...
export const KidsClass: FC<{
  ...
  return <Section state={state}>
    ...
    <p>During the 14 lessons of this course we’ll get to know all sorts of clay, be it white, black or red. We will try
      out different techniques, experimenting with kneading, rolling, stamping, and carving. We will create dishes,
      build cities, make toys, tiles and many other things!</p>
